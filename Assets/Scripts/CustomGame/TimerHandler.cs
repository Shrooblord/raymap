...
namespace CustomGame {
    ...
    public class Timer {
        ...
        public void Start(float seconds, bool restart = true) {
        ...
        public void Start(float seconds, Action onFinishAction, bool restart = true) {
            Start(seconds, restart);
        ...
        public static Timer StartNew(float seconds, Action onFinishAction, bool restart = true) {
            var t = new Timer();
            t.Start(seconds, onFinishAction, restart);
            return t;
        }
    }
}